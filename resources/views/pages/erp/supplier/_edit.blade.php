...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="id" value="{{$supplier->id}}" id="id" placeholder="Id">
	</div>
</div>
<div class="row mb-3">
...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="company" value="{{$supplier->company}}" id="company" placeholder="Company">
	</div>
</div>
<div class="row mb-3">
